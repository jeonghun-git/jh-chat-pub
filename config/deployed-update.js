...
(async () => {
  ...
  console.purple('Removing all tags for jh-chat `deployed` images...');
  ...
  console.purple('Pulling latest jh-chat images...');
  ...
  console.green('Your jh-chat app is now up to date! Start the app with the following command:');
  console.purple(startCommand);
  console.orange(
    'Note: it\'s also recommended to clear your browser cookies and localStorage for jh-chat to assure a fully clean installation.',
  );
